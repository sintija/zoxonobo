...
import FestivalInfo from './components/FestivalInfo/FstivalInfo';
// Import animations
        ...
        <div className="app" style={{overflow: "hidden"}}>
                <>
                    ...
                    <div ref={containerRef} className="content-container">
                        ...
                        <div className="festival-info-wrapper">
                            <FestivalInfo contentRef={festivalInfoRef} />
                        </div>
                    </div>
